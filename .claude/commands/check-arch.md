...
1. Read the lookup table in `daemon/CLAUDE.md` (top section, near "Lookup table — where to find canonical info").
...
Recommendation: add a row to the daemon/CLAUDE.md lookup table:
| <topic> | <file> | §<section> |
```
