...
// W2-audit/097 — the typed AuditTrail serve (proj_audit_trail → frozen AuditEventRow); pub for the
// integration test. `get_projection` routes AuditTrail to it (the Review/Session precedent).
pub use methods::read_audit_typed;
// W2-usage/098 — the typed UsageLedger serve (proj_usage_ledger → frozen UsageRow); pub for the
// integration test. `get_projection` routes UsageLedger to it (the Audit/Review precedent).
pub use methods::read_usage_typed;
