...
- A lightweight IDE-style operational workspace.
...
4. GitHub/Linear issue and ticket inbox.
5. Worktree, git, PR, and merge control center.
6. Agent team topology view.
7. Right-side contextual inspector.
8. Bottom event/activity timeline.
9. Global command palette.
10. Settings/integrations area.
...
3. **GitHub/Linear Task Inbox**  
   This shows how work enters the system.

4. **Worktree/Git/PR Control Center**  
...
> Make the project graph the operational home base, and make every terminal, issue, ticket, branch, worktree, PR, and agent team attach to it.
